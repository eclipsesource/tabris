...
public class RequestKeyProviderTest {
  ...
  @Test
  public void testStoresActionOutlink() {
    assertEquals( "link", requestKeys.get( "ACTION_OUTLINK" ) );
  }

  @Test
  public void testStoresActionDownload() {
    assertEquals( "download", requestKeys.get( "ACTION_DOWNLOAD" ) );
  }
  ...
  @Test
  public void testStoresEcommerceId() {
    assertEquals( "ec_id", requestKeys.get( "ECOMMERCE_ORDER_ID" ) );
  }

  @Test
  public void testStoresEcommerceSubtotal() {
    assertEquals( "ec_st", requestKeys.get( "ECOMMERCE_SUB_TOTAL" ) );
  }

  @Test
  public void testStoresEcommerceTaxAmount() {
    assertEquals( "ec_tx", requestKeys.get( "ECOMMERCE_TAX_AMOUNT" ) );
  }

  @Test
  public void testStoresEcommerceShippingCost() {
    assertEquals( "ec_sh", requestKeys.get( "ECOMMERCE_SHIPPING_COST" ) );
  }

  @Test
  public void testStoresEcommerceDiscount() {
    assertEquals( "ec_dt", requestKeys.get( "ECOMMERCE_DISCOUNT" ) );
  }

  @Test
  public void testStoresEcommerceItems() {
    assertEquals( "ec_items", requestKeys.get( "ECOMMERCE_ITEMS" ) );
  }
