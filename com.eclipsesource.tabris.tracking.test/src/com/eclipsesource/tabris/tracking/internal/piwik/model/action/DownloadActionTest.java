...
public class DownloadActionTest {
  ...
  @Test
  public void testSetsActionUrlAsDownload() throws Exception {
    DownloadAction downloadAction = new DownloadAction( "foo" );

    assertEquals( "foo", downloadAction.getParameters().get( getRequestKey( ACTION_DOWNLOAD ) ) );
  }
}
